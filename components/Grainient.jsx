...
const Grainient = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      // WebGL unavailable (older device, disabled GL, headless browser, etc.).
      // Fail silently — the static gradient fallback already painted via CSS.
      // eslint-disable-next-line no-console
      console.warn('[Grainient] WebGL unavailable, skipping background.', err);
      return;
    }
