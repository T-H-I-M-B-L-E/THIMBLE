...
export function EditProfileModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (usernameChanged) {
      if (usernameLocked) {
        setUsernameError(
          `You can change your username again on ${nextAllowed!.toLocaleDateString()}.`,
        );
        return;
      }
      if (!USERNAME_RE.test(trimmedUsername)) {
        setUsernameError(
          "3–30 chars. Lowercase letters, numbers, underscore or dot. Must start and end with a letter or number.",
        );
        return;
      }
    }
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-full max-w-none h-dvh sm:h-auto sm:w-[95vw] sm:max-w-125 rounded-none border-0 sm:border sm:border-neutral-200 dark:sm:border-neutral-800 p-0 overflow-hidden bg-white dark:bg-black flex flex-col">
        ...
        <form
          ...
          className="p-6 space-y-6 flex-1 overflow-y-auto sm:max-h-[70vh]"
        >
          {/* Avatar Section */}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center border border-neutral-200 dark:border-neutral-800">
                <span className="px-3 text-sm text-neutral-400 select-none">
                  @
                </span>
                <Input
                  value={username}
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="rounded-none min-h-25 border-neutral-200 dark:border-neutral-800 focus:ring-0 resize-none text-sm"
