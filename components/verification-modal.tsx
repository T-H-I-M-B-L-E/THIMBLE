...
export function VerificationModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-full max-w-none h-dvh sm:h-auto sm:w-[95vw] sm:max-w-120 p-0 overflow-hidden flex flex-col">
        <DialogHeader className="p-5 border-b border-neutral-100 dark:border-neutral-900 shrink-0 flex flex-row items-center gap-3">
          <span
            style={{
              width: 32,
              height: 32,
        ...
        <div className="flex-1 overflow-y-auto p-5">
          {loading ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              {wasRejected && (
                ...
                >
                  ...
                  {existing?.adminNote && (
                    <>
                      {" "}
                      Reason: <em>{existing.adminNote}</em>
                    </>
                  )}{" "}
                  You can apply again.
                </div>
              ...
              >
                Verification adds a gold badge to your name. Submit your details
                and a photo of your government ID. We'll review within a few
                days.
              </p>
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      >
        ...
        {hint && (
          <span
            style={{ color: "var(--t-ink-3)", fontWeight: 400, marginLeft: 6 }}
          >
            ({hint})
          </span>
        )}
...
function StatusCard({
  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: 13, color: "var(--t-ink-2)", lineHeight: 1.5 }}>
        {body}
      </p>
      {footnote && (
        <p style={{ fontSize: 11, color: "var(--t-ink-3)", marginTop: 14 }}>
          {footnote}
        </p>
      )}
    </div>
