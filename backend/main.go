...
func registerRoutes(app *fiber.App, authLimiter fiber.Handler, apiLimiter fiber.Handler) {
	...
	adminGroup.Get("/aria/history", handlers.AdminARIAHistory)
	adminGroup.Post("/aria/history", handlers.AdminARIASaveMessage)
	adminGroup.Delete("/aria/history", handlers.AdminARIAClearHistory)
